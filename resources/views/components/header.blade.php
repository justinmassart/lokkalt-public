                ...
                <div class="header__top__menu__profile__avatar" x-data="{ open: false }">
                    ...
                    <div class="header__top__menu__profile__avatar__dropdown" x-cloak x-show="open"
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="link" title="{!! __('links.login_title') !!}" hreflang="{!! explode('-', app()->currentLocale())[0] !!}"
                                    href="{{ LaravelLocalization::getURLFromRouteNameTranslated(app()->currentLocale(), 'routes.login') }}">@lang('header.login')</a>
                            </li>
                            <li>
                                <a class="link" title="{!! __('links.register_title') !!}" hreflang="{!! explode('-', app()->currentLocale())[0] !!}"
                                    href="{{ LaravelLocalization::getURLFromRouteNameTranslated(app()->currentLocale(), 'routes.create-my-account') }}">@lang('header.create_my_account')</a>
                            </li>
                        </ul>
                    </div>
                </div>
