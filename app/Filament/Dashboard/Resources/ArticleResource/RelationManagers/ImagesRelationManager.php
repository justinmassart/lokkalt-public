...
class ImagesRelationManager extends RelationManager
{
    ...
    {
        return __('filament.common_images');
    }
        ...
        return $form
            ->schema([
                FileUpload::make('images.url')
                    ...
                    ->hint(__('filament.images_input_hint'))
                    ->columnSpanFull()
                    ->panelLayout('grid')
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ...
                    ->modalSubmitActionLabel(__('buttons.upload'))
                    ->createAnother(false)
                    ...
                    ->action(static function (array $data, RelationManager $livewire) {
                        ...
                        $analyze = $image->uploadImages($data['images'], $article);
                        if (count($analyze) >= 1) {
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->action(static function (Model $record) {
                        $record->deleteArticleImage($record);
